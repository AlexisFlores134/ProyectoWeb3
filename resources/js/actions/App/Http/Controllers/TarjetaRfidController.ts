...
/**
* @see \App\Http\Controllers\TarjetaRfidController::verificarAcceso
 * @see app/Http/Controllers/TarjetaRfidController.php:77
 * @route '/api/verificar-acceso'
 */
export const verificarAcceso = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: verificarAcceso.url(options),
    method: 'post',
})

verificarAcceso.definition = {
    methods: ["post"],
    url: '/api/verificar-acceso',
 ...
 * @route '/api/verificar-acceso'
 */
verificarAcceso.url = (options?: RouteQueryOptions) => {
    return verificarAcceso.definition.url + queryParams(options)
}
 ...
 * @route '/api/verificar-acceso'
 */
verificarAcceso.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: verificarAcceso.url(options),
    method: 'post',
})
 ...
 * @route '/api/verificar-acceso'
 */
    const verificarAccesoForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: verificarAcceso.url(options),
        method: 'post',
    })
 ...
 * @route '/api/verificar-acceso'
 */
        verificarAccesoForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: verificarAcceso.url(options),
            method: 'post',
        })
    
    verificarAcceso.form = verificarAccesoForm
/**
...
const TarjetaRfidController = { verificarAcceso, index, store, show, update, destroy }

export default TarjetaRfidController